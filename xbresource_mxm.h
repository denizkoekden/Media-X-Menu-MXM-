...
public:
    ...
    // Loads the resources out of the specified bundle in memory
    HRESULT CreateFromMem( LPDIRECT3DDEVICE8 pd3dDevice, LPCTSTR szSection, const LPBYTE pDataBuffer, 
                    DWORD dwNumResources, XBRESOURCE* pResourceTags = NULL );
