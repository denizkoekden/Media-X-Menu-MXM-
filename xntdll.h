...
// If these flags are set, it detarmines how the values will be set.
#define	NETPARM_IP_MANUAL	0x00000004
#define	NETPARM_DNS_MANUAL	0x00000008
...
extern "C" {
extern bool WINAPI NtSetSystemTime( PFILETIME  SystemTime, PFILETIME PreviousTime );
};
