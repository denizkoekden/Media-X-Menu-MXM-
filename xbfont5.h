...
public:
	...
	DWORD	m_dwFillColor;
	DWORD	GetAdjustedFillColor( void );
	DWORD	GetAdjustedOutlineColor( void );
//	DWORD	m_dwTimer;
};
...
//-----------------------------------------------------------------------------
// Flags for the CXBFontFive::DrawText() function
//-----------------------------------------------------------------------------
...
public:
    ...
    HRESULT Create( LPDIRECT3DDEVICE8 pd3dDevice, const CHAR* strFontResourceFileName, DWORD dwResourceOffset=0UL );
    HRESULT CreateFromMem( LPDIRECT3DDEVICE8 pd3dDevice, LPCTSTR szSection, 
    ...
    HRESULT DrawText( DWORD dwColor, const WCHAR* strText, DWORD dwFlags=0L,
                      FLOAT fMaxPixelWidth = 0.0f, CCaratInfo * pCaratInfo = NULL );
    HRESULT DrawText( FLOAT sx, FLOAT sy, DWORD dwColor, 
                      const WCHAR* strText, DWORD dwFlags=0L,
                      FLOAT fMaxPixelWidth = 0.0f, CCaratInfo * pCaratInfo = NULL );
    HRESULT End();

	void	CleanString( CStdString & sString );
	void	WrapString( CStdString & sString, int iPixelWidth );
