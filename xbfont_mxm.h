...
public:
    ...
    HRESULT GetTextExtent( const char* strText, FLOAT* pWidth, 
                           FLOAT* pHeight, BOOL bFirstLineOnly=FALSE ) const;

    FLOAT   GetTextWidth( const WCHAR* strText ) const;
//    FLOAT   GetTextWidth( const char* strText ) const;
...
public:
    ...
    // Replaces invalid (outside the valid glyph range) characters in a string
    VOID    ReplaceInvalidChars( WCHAR* strUpdate, WCHAR cReplacement );
